...
export function getDinoRect() {
  // getBoundingClientRect() returns a DOMRect object which is the smallest
...
function handleJump(delta) {
  ...
  // when character descends to bottom value, jumping ends animation ends and running animation resumes
